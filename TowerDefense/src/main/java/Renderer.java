...
public class Renderer {
    ...
    public void renderAttackStrategySelection (){
        System.out.println();
        System.out.println("Select targeting: [F]irst-in-line or [L]ast-in-line (press F or L)");
        System.out.println("First-in-line will target enemies that are furthest along the path.");
        System.out.println("Last-in-line will target enemies that are closest to the start and visible to the tower.");
    }
